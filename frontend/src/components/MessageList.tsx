    ...
    <div className="flex-1 overflow-y-auto px-4 py-6">
      ...
      <div className="max-w-4xl mx-auto space-y-6">
        {messages.map((message, index) => {
          ...
          return (
            ...
            >
              {/* 头像 */}
              {!isOwn && showAvatar && (
                <div className={`w-10 h-10 rounded-xl ${getAvatarColor(message.sender)} flex items-center justify-center text-white text-sm font-bold shadow-lg shadow-gray-200/50 flex-shrink-0`}>
                ...
                >
                  {message.content.content_type === 'text' ? (
                    ...
                    <img
                      ...
                      alt="Shared image"
                      className="max-w-full rounded-lg min-w-[200px]"
                    />
                  )}
        ...
        {typingUsers.length > 0 && (
          <div className="flex items-center gap-2 px-4 py-3 bg-white/80 backdrop-blur-sm rounded-2xl rounded-tl-sm shadow-sm border border-gray-100 w-fit ml-13">
